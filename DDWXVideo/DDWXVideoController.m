...
#import "DDPlayVideoController.h"
...
@interface DDWXVideoController ()<AVCaptureFileOutputRecordingDelegate>
{
/**
...
@implementation DDWXVideoController
...
- (void)makeUI{
    ...
    [flashBtn.titleLabel setFont:FONT(FLASHBTN_FONT)];
    [flashBtn sizeToFit];
    ...
    [cameraBtn.titleLabel setFont:FONT(CAMERABTN_FONT)];
    [cameraBtn sizeToFit];
    ...
    tipCancleLabel.font = FONT(TIPCANCLELABEL_FONT);
    ...
    tipLabel.font = FONT(TIPLABEL_FONT);
    [tipLabel sizeToFit];
    ...
    tapLabel.font = FONT(TAPLABEL_FONT);
    ...
    [backBtn.titleLabel setFont:FONT(BACKBTN_FONT)];
    [backBtn sizeToFit];
...
{
    DDPlayVideoController *playCtrl = [[DDPlayVideoController alloc]init];
